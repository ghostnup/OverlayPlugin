...
namespace RainbowMage.OverlayPlugin
{
    ...
    public static class Localization
    {
        ...
        static Localization()
        {
            ...
            dict[TextItem.ErrorTitle, "zh"] = "错误";
            ...
            dict[TextItem.RequiredAssemblyFileNotFound, "zh"] = "需求的组装文件 {0} 未找到。";
            ...
            dict[TextItem.RequiredAssemblyFileCannotRead, "zh"] = "不能加载需求的组装文件 {0}.";
            ...
            dict[TextItem.RequiredAssemblyFileBlocked, "zh"] = "因安全问题不能加载需求的组装文件 {0} 。文件似乎已经被屏蔽或放置在不受信任的区域(如网络驱动器)。";
            ...
            dict[TextItem.RequiredAssemblyFileException, "zh"] = "加载所需的装配文件时发生异常{0}:\n{1}";
            ...
            dict[TextItem.SortStringDescending, "zh"] = "文字 - 降序";
            ...
            dict[TextItem.SortNumberAscending, "zh"] = "数值 - 升序";
            ...
            dict[TextItem.SortNumberDescending, "zh"] = "数值 - 降序";
